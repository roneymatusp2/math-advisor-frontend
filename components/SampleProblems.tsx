// src/components/SampleProblems.tsx
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="mb-4">
                <p className="mb-2">
                  A survey at a local cafe records the number of coffee cups sold over 5 consecutive days:
                </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="mb-4">
                ...
                <p>
                  where n is the number of products sold (in hundreds). If the company wants to maximize the weekly profit,
                  for what integer value of n does this maximum occur?
                </p>
              </div>
              <div className="space-y-2">
